...
export default function Project() {
    ...
    return (
        <div className='flex flex-col items-center mt-5 md:mt-0 md:justify-center justify-start w-full h-full gap-6 text-4xl text-white '>
            <div className='items-center md:items-start justify-center text-white  gap-10 flex flex-col 
            md:flex-row md:mt-20  w-[calc(100%-30px)] mx-[30px] md:w-[calc(100%-60px)] md:mx-[0px] md:h-[500px] h-[480px]'>
